    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Inertia.delete(route("konsultasi.destroy", id));
                Swal.fire("Terhapus!", "Data Konsultasi telah dihapus.", "success");
            }
        });
    };
...
const formatDate = (dateString) => {
    if (!dateString) {
        return "Belum Dijawab"; // Return default message if no date
    }
